    ...
    def run(self, state: TradingState) -> tuple:
        ...
        for product in state.order_depths:
            ...
            if is_hydrogel:
                ...
                trend_confidence_hp = trend_confidence if is_hydrogel else 0
                skew_weight = 3.0 - trend_confidence_hp * 1.5  # 3.0 → 1.5
            elif is_vev:
                skew_weight = 2.0
            else:
                skew_weight = 3.0
            ...
            # Add trend bias for HYDROGEL
            hp_trend_bias = trend_bias if is_hydrogel else 0
            adj_fair = fair + (imbalance * 1.0) - (exp_skew * skew_weight) + hp_trend_bias
